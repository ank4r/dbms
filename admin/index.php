...
<head>
    ...
    <title>Approve Faculty Members</title>
    <!-- Bootstrap Styles-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="table1" onclick="handleClick(event);">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Faculty ID</th>
                                    ...
                                    <tbody>
                                        <?php
                                          ...
                                          <tr>
                                            ...
                                            <td><input id="edit" type="submit" name="edit" value="Approve"></td>
                                          </tr>
                                        <?php } 
                                        mysql_close();
                                        ?>
