                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                <li class="active"><a href="#createCourse-pills" data-toggle="tab">Create Course</a>
                                </li>
                                <li class=""><a href="#courseStatus-pills" data-toggle="tab">Course Status</a>
                                </li>
                                <li class=""><a href="#manageCourse-pills" data-toggle="tab">Manage Course</a>
                                </li>
                                <li class=""><a href="#forum-pills" data-toggle="tab">Forum</a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade  active in" id="createCourse-pills">
                        ...
                        <!-- /.panel-body -->
                                ...
                                <div class="tab-pane fade" id="courseStatus-pills">
                                   <?php
                                        ...
                                        $warning=get_warning_course('ravi1996');
                                        ...
                                        echo "<button type='submit' class='btn btn-default' >Publish</button>";
                                         ...
                                         $normal=get_normal_course('ravi1996');
                                ...
                                <div class="tab-pane fade" id="manageCourse-pills">
                                    <h4>Manage Course</h4>
                                    <div class="form-group">

                                    </div>
                                <div class="tab-pane fade" id="forum-pills">
                                    <h4>Messages Tab</h4>
